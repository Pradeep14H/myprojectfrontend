          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            ...
            <ul className="navbar-nav">
              <li className="nav-item">
                <a className="nav-link text-black" href="/tlemplist">
                <b> Employee List</b>
                </a>
              </li>
              &nbsp; &nbsp;
              <li className="nav-item">
                <a className="nav-link text-black" href="/tltasklist">
                <b>Task List</b>
                </a>
              </li>
              &nbsp; &nbsp;
              <li className="nav-item">
                <a className="nav-link text-black" href="/tlprojectlist">
                <b>Project List</b>
                </a>
              </li>
              &nbsp; &nbsp;
              <li className="nav-item">
                <a className="nav-link text-black" href="/tlteamlist">
                <b>Team List</b>
                </a>
              </li>
