...
import TLTaskList from './components/TLTaskList';
import TLProjectList from './components/TLProjectlist';
import TLEmplist from './components/TLEmplist';
import TLTeamList from './components/TLTeamList';
    ...
    <div>
        <Router>
                    ...
                    <Route exact path="/register" component={Registration} />
                          ...
                          <Route path = "/tltasklist" component = {TLTaskList}></Route>
                          <Route path = "/tlprojectlist" component = {TLProjectList}></Route>
                          <Route path = "/tLemplist" component = {TLEmplist}></Route>
                          <Route path = "/tlteamlist" component = {TLTeamList}></Route>
