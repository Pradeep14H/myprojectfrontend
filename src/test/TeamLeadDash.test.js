...
describe('TeamLeadDash component', () => {
  ...
  it('has a link to the employee list page', () => {
    const employeeListLink = wrapper.find('a[href="/tlemplist"]');
